...
public class CommonMethods {
	...
	public void selectRadioButton(List<WebElement> wes, String option) throws Exception {
		boolean flag = false;
		...
		if (flag == false)
			throw new Exception(option + " Radio button Option is not available for selection");
	}
